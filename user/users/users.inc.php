...
class AdminUsers extends ComponentAdmin
{
	...
	public function on_access_set()
	{
		...
		$fields['access'] = $this->parse_access_list(explode(",", $fields['access']));
	...
	private function make_access_options()
	{
		...
		list($access_option, $access_optgroup) = $this->Templates->get_params(array("access_option", "access_optgroup"), false);
