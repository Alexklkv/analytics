...
window.TabKeys = {
	'init': function(collection)
	{
		...
		{
			$(document).off("keydown", collection, this.down);
			$(document).on("keydown", collection, this.down);

			$(document).off("keypress", collection, this.up);
			$(document).on("keypress", collection, this.up);
		}
		else
		{
			$(document).off("keypress", collection, this.press);
			$(document).on("keypress", collection, this.press);
		}
	},
