...
require_once "bottlee_counters.inc.php";

use Bottlee\Counters as Counters;
 ...
 * @version 1.0.1
 */
class ObjectBottlee extends Object implements DatabaseInterface
{
	/**
	...
	private $currency = "$";
	private $content = "http://bottleeng.realcdn.ru/content.xml";
...
*/
	...
	public function counters_dau_net_age($cache_date)
	{
		...
		return array($dau_fb_age, $dau_rg_age);
	}
	...
	public function counters_mau_net_age($cache_date)
	{
		...
		return array($mau_fb_age, $mau_rg_age);
	}
...
*/
	...
	public function api_browsers($cache_date)
	{
		$paths = array(
			array("BROWSER"),
			array(0 => "CHROME", 1 => "FIREFOX", 2 => "MSIE", 3 => "OPERA", 4 => "SAFARI", 5 => "YANDEX", 6 => "AMIGO", 7 => "UNKNOWN"),
			false
		);
	...
	public function api_lag_page($cache_date)
	{
		...
		$paths = array(
			array("LAG"),
			array(0 => "ACHIEVEMENTS", 1 => "APARTMENTS", 2 => "CHAT", 3 => "DISCONNECTED", 4 => "GAME", 5 => "MODERATION", 6 => "PROFILE", 7 => "RATINGAPARTMENTS", 8 => "RATINGCOMMON", 9 => "RATINGDAY", 10 => "RATINGPETS", 11 => "RATINGRICH", 12 => "SEARCH", 13 => "WEDDING"),
			array("FB")
		);
